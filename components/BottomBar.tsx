    ...
    <div className="flex overflow-x-auto overflow-y-hidden [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none] flex-row justify-between w-full h-[36px] min-h-[36px] border-t border-primaryStroke px-[24px] gap-[16px] items-center min-w-0">
      ...
      <div className="flex flex-row flex-shrink-0 gap-[8px] justify-start items-center">
        ...
        <div className="flex flex-1 flex-row w-full gap-[8px] justify-start items-center">
          <span className="contents">
            <button className="hidden 2xl:flex flex-row flex-shrink-0 h-[24px] px-[0px] gap-[4px] justify-start items-center hover:brightness-110 transition-all duration-125 ease-in-out" style={{ color: "#F7931A" }}>
          ...
          <span className="contents">
            <button className="hidden 2xl:flex flex-row flex-shrink-0 h-[24px] px-[0px] gap-[2px] justify-start items-center hover:brightness-110 transition-all duration-125 ease-in-out" style={{ color: "#497493" }}>
          ...
          <span className="contents">
            <button className="hidden lg:flex flex-row flex-shrink-0 h-[24px] px-[0px] gap-[4px] justify-start items-center hover:brightness-110 transition-all duration-125 ease-in-out" style={{ color: "#14F195" }}>
